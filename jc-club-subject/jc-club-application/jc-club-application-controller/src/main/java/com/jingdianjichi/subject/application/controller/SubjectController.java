...
public class SubjectController {
    ...
    public Result<Boolean> add(@RequestBody SubjectInfoDTO subjectInfoDTO){
        try {
            ...
            List<SubjectAnswerBO> answerBOListboList =
                    SubjectAnswerDTOConverter.INSTANCE.convertDTOListToBo(subjectInfoDTO.getOptionList());
            subjectInfoBO.setOptionList(answerBOListboList);
